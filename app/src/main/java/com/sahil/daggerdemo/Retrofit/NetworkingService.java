...
public class NetworkingService {
    ...
    public Subscription getNewsList(final GetNewsListCallback callback, String category, int page) {

        return networkService.getNewsList("Bearer "+ BuildConfig.APIKEY,"in",category,20,page )
